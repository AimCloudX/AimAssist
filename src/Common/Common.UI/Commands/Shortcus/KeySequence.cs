...
namespace Common.UI.Commands.Shortcus
{
    public class KeySequence
    {
        ...
        [JsonConstructor]
        public KeySequence(Key firstKey, ModifierKeys firstModifiers, Key? secondKey = null,
        ...
        {
            return HashCode.Combine((int) FirstKey, (int) FirstModifiers, SecondKey, SecondModifiers);
        }
